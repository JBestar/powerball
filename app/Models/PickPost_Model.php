...
/**
 * 분석픽공유 게시판 — 테이블 pick_post (pick_post.sql)
 */
class PickPost_Model extends Model
{
    protected $table = 'pick_post';
    ...
    /**
     * DBPrefix 와 무관하게 물리 테이블명 pick_post 사용
     */
