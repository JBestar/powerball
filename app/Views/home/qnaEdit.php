...
<body>
	<div class="freeRegisterWrap">
		...
		<form method="post" action="<?= site_furl('/?view=qnaEdit&id=' . (int) ($post->id ?? 0)) ?>">
				...
				<tr class="formRow">
					<td>
						<div class="formBox" style="margin-top:10px;">
							<textarea name="content" class="input" maxlength="50000" placeholder="내용"><?= esc($post->content ?? '') ?></textarea>
						</div>
					</td>
				</tr>
